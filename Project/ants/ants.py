...
class Ant(Insect):
    ...
    def double(self):
        ...
        # BEGIN Problem 12
        "*** YOUR CODE HERE ***"
        if self.double_marked is False:
            self.damage *= 2
        # END Problem 12
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        distance = 0
        while distance < self.lower_bound and current_place.is_hive is False:
            current_place = current_place.entrance
            distance += 1
        while current_place.bees == [] and current_place.is_hive is False and self.lower_bound <= distance <= self.upper_bound:
            current_place = current_place.entrance
            distance += 1
        if current_place.is_hive == True or distance > self.upper_bound:
            return None
        else:
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 8a
        "*** YOUR CODE HERE ***"
        return self.ant_contained == None and other.is_container is False
        # END Problem 8a
        ...
        while place is not None:
            if place.ant is not None:
                if place.ant.is_container and place.ant.ant_contained is not None:
                    ...
                    place.ant.ant_contained.double_marked = True
                place.ant.double()
                place.ant.double_marked = True
            place = place.exit
        # END Problem 12
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self):
        ...
        while current_place.is_hive is False:
            if current_place.ant and current_place.ant is not self:
                inserts[current_place.ant] = distance
            if current_place.bees != []:
                bees = current_place.bees[:]
                for bee in bees:
                    inserts[bee] = distance
            current_place = current_place.entrance
            distance += 1
        return inserts
        # END Problem Optional 2
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem Optional 2
        damage = self.base_damage - distance * self.damage_reduction - self.insects_shot * self.battery_usage
        return max(0, damage)
        # END Problem Optional 2
